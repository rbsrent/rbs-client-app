...
export default function PiersScreen() {
  ...
  // Fit all markers after piers load
  useEffect(() => {
    if (piersWithCoords.length > 0) {
      setTimeout(fitAll, 600);
    }
  }, [piersWithCoords.length]);
        ...
        <>
          ...
          {mode === "map" && (
            <View style={s.mapContainer}>
              ...
              {/* Fit all button */}
              <Pressable
                style={[s.fabFit, { bottom: focused ? 168 : 24 }]}
                onPress={fitAll}
                hitSlop={8}
              >
                <Navigation
              ...
              {focused && (
                <View
                  style={[s.focusCard, { paddingBottom: insets.bottom + 16 }]}
                >
                  <View style={s.focusCardInner}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      {focused.description ? (
                        <Text style={s.focusDesc} numberOfLines={2}>
                          {focused.description}
                        </Text>
                      ) : null}
                    </View>
