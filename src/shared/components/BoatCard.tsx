              ...
              <View style={s.ratingBadgeRow}>
                {(boat.rating ?? 0) >= 5 && (
                  <View style={[s.tagFilled, { backgroundColor: COLORS.red }]}>
                    <Text style={[s.tagFilledTxt, { color: "#fff" }]}>ХИТ</Text>
                  </View>
                )}
                <View style={[s.tagFilled, { backgroundColor: COLORS.warning }]}>
                  <Text style={[s.tagFilledTxt, { color: "#fff" }]}>ЛУЧШИЕ ОТЗЫВЫ</Text>
                </View>
              </View>
            ) : topBadge ? (
              isCatalog ? (
                <LinearGradient colors={["#F9F9F9", "#F5F5F5"]} style={s.catalogBadge}>
      ...
      {isCatalog ? (
        <View style={s.catalogInfo}>
          ...
          <View style={s.catalogPriceRow}>
            ...
            {originalPrice ? (
              <Text style={[s.catalogMetaTxt, s.catalogOld]}>
          ...
          {boat.pier_name ? (
            <View style={s.locationRow}>
              ...
              <Text style={[s.catalogMetaTxt, { flex: 1 }]} numberOfLines={1}>
                {boat.pier_name}
              </Text>
            </View>
          ) : null}
...
const s = StyleSheet.create({
  ...
  discountTxt: { fontSize: 12, fontWeight: "800", color: COLORS.red },
